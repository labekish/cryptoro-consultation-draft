      ...
      <div class="team-grid">
        <article class="team-card">
          <div class="team-card__photo">
            <img src="<?= htmlspecialchars($assetBase, ENT_QUOTES) ?>/images/cons1.png" alt="Александр" loading="lazy" width="200" height="200">
          </div>
          <p class="team-card__name">Александр</p>
        </article>
        <article class="team-card">
          <div class="team-card__photo">
            <img src="<?= htmlspecialchars($assetBase, ENT_QUOTES) ?>/images/cons2.png" alt="Виталий" loading="lazy" width="200" height="200">
          </div>
          <p class="team-card__name">Виталий</p>
        </article>
        <article class="team-card">
          <div class="team-card__photo">
            <img src="<?= htmlspecialchars($assetBase, ENT_QUOTES) ?>/images/cons3.png" alt="Анатолий" loading="lazy" width="200" height="200">
          </div>
          <p class="team-card__name">Анатолий</p>
        </article>
        <article class="team-card">
          <div class="team-card__photo">
            <img src="<?= htmlspecialchars($assetBase, ENT_QUOTES) ?>/images/cons4.png" alt="Максим" loading="lazy" width="200" height="200">
          </div>
          <p class="team-card__name">Максим</p>
        </article>
      </div>
    </section>
